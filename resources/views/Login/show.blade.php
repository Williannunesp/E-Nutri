...
<a class="nav-link" href="{{route('telacaduser')}}">
    ...
    <table id="datatablesSimple">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $user->name }}</td>
                <td>{{ $user->rm }}</td>
                <td><a href="{{route('telaedituser', ['id' => $user->id])}}">
                ...
                <td>
                    <form action="{{route('exluiruser', ['id' => $user->id])}}" method="post" onsubmit="
                    return confirm('tem certeza que deseja remover o usuário de {{ addslashes($user->namecomp)}}?')">
                    @csrf
