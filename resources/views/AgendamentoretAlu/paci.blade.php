                        ...
                        <div class="row mb-4">
                            <div class="col-md-4">
                                <div class="form-floating mb-3 mb-md-0">
                                    <input class="form-control" id="name"  autocomplete="name"  minlength="11" maxlength="11" name="name" type="text" value="{{$agenda->paciente->name}}" required placeholder="Enter your first name" />
