    ...
    <table id="datatablesSimple">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><a href="{{route('telaeditpaciente', ['id' => $paciente->id])}}">
                ...
                <td>
                    <form action="{{route('exluirpaciente', ['id' => $paciente->id])}}" method="post" onsubmit="
                    return confirm('tem certeza que deseja remover paciente {{ addslashes($paciente->name)}}?')">
                    @csrf
