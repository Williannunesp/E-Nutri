...
class PrimeiracosnutaController extends Controller
{
    /**
    ...
    {
        return view('primeiraconsultaprof.create');
    }
    ...
    public function create()
    {
        if (Auth::check()){//verifica se possui usuário logado.
            ...
            if($acesso[0]->acesso_id == 1){//verifica se é professor para acessar cadastro de usuário.
                ...
                return view('primeiraconsultaprof.create', ['user'=>$user]);//tela de cadastro de usuário.
